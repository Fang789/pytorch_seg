...
if __name__=="__main__":
	...
	from augment import get_validation_augmentation,get_training_augmentation
	import time
	train_txt="../txt/camvid_train.txt"
	height,width = 360,480
	train_dataset = Dataset(train_txt,height=height,width=width,classes=11,
